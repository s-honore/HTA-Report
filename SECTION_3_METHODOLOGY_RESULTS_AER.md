...
**Treatment Effect Scenarios.** Absent clinical trial data and lacking mechanistic understanding of the dose-response relationship between enzyme restoration and kidney disease progression, we model three treatment effect scenarios reflecting plausible efficacy outcomes informed by carrier biology. Female carriers expressing approximately 50 percent of normal OCRL enzyme typically remain free of progressive renal dysfunction (Charnas et al. 2000; Bökenkamp & Ludwig 2016; Röschinger et al. 2000), providing the strongest biological anchor for treatment expectations. However, the precise relationship between enzyme levels and clinical benefit remains unknown—the dose-response curve could be linear, threshold-dependent, or follow a more complex sigmoidal pattern. We therefore define scenarios based on clinical judgment rather than mechanistic modeling:

**Primary Scenario (Carrier Analogy):** 50% enzyme restoration → 85% reduction in eGFR decline, based on the observation that carriers with ~50% OCRL activity do not develop progressive kidney disease. This assumes the male patient with constitutive 50% enzyme activity will achieve outcomes comparable to the typical carrier phenotype.

**Intermediate Scenario:** 30% enzyme restoration → 65% reduction in eGFR decline, representing suboptimal gene transfer efficiency that still provides substantial clinical benefit but falls short of complete ESKD prevention.

**Conservative Scenario:** 15% enzyme restoration → 35% reduction in eGFR decline, representing minimal therapeutic benefit at the lower bound of plausible efficacy.

While rare cases of severe phenotype occur in carriers despite 50% enzyme activity—likely due to skewed X-inactivation (Yamamoto et al. 2019)—the vast majority demonstrate no renal progression, supporting the primary scenario as the expected outcome. The intermediate and conservative scenarios address uncertainty regarding whether male patients will uniformly achieve carrier-analogous outcomes or whether additional factors may reduce efficacy. The specific decline reduction percentages (85%, 65%, 35%) represent clinical judgment spanning optimistic, moderate, and pessimistic outcomes rather than predictions from a validated dose-response model. Detailed scenario specifications:

- **Scenario 1 (50% Enzyme Restoration - Carrier Analogy):** Gene therapy achieving 50 percent enzyme restoration (E = 0.50) yields 85 percent reduction in eGFR decline (θ = 0.85), from natural rate δ = 1.10 ml/min/1.73m²/year to treated rate 0.17 ml/min/1.73m²/year. This represents efficacy comparable to the typical carrier phenotype wherein female carriers with approximately 50% OCRL activity remain free of progressive renal disease throughout life, despite exhibiting subtle lenticular opacities (Röschinger et al. 2000; Bökenkamp & Ludwig 2016). Biological plausibility derives from the consistent observation across multiple cohorts that carriers do not develop chronic kidney disease or ESKD (Charnas et al. 2000).

- **Scenario 2 (30% Enzyme Restoration):** Partial enzyme restoration (E = 0.30) yields 65 percent reduction (θ = 0.65) in eGFR decline to 0.39 ml/min/1.73m²/year. This intermediate scenario reflects suboptimal but clinically meaningful gene transfer efficiency, delaying but not preventing ESKD progression.

- **Scenario 3 (15% Enzyme Restoration - Minimal Benefit):** Minimal enzyme restoration (E = 0.15) yields 35 percent reduction (θ = 0.35) in eGFR decline to 0.72 ml/min/1.73m²/year. This conservative scenario represents threshold efficacy, providing modest benefit insufficient to prevent ESKD within typical lifespan.
...
**Implications for Pricing Strategy.** These results demonstrate efficacy-dependent pricing: achieving carrier-level enzyme restoration justifies prices approaching €3.5 million under ultra-rare disease thresholds—comparable to approved gene therapies like Hemgenix (€3.5M) and Elevidys (€3.2M)—while minimal enzyme restoration supports approximately €1 million even at generous thresholds. The wide justified price ranges reflect substantial clinical benefit (8.1 QALYs, 19 life years gained in primary scenario) when appropriately discounted at 1.5% for curative therapies with sustained long-term benefits.

**Uncertainty in Carrier Analogy.** The primary scenario assumes 50% enzyme restoration prevents progressive kidney disease based on carrier biology wherein the vast majority of female carriers with ~50% OCRL activity remain free of renal dysfunction throughout life (Röschinger et al. 2000; Bökenkamp & Ludwig 2016). However, rare cases of full Lowe syndrome phenotype have been reported in carriers with 50% enzyme activity, typically due to skewed X-inactivation (Yamamoto et al. 2019), and nearly all carriers exhibit subtle lenticular opacities. This heterogeneity introduces uncertainty regarding whether 50% enzyme restoration in male patients will uniformly prevent kidney disease or whether additional factors (genetic modifiers, X-inactivation patterns in carriers vs. constitutive 50% activity in treated males) may influence outcomes. Scenarios 2 and 3 address this uncertainty by modeling lower efficacy (30% and 15% enzyme restoration), providing value estimates across plausible outcome ranges. Phase 3 trial design should prioritize enzyme activity as a key secondary endpoint to inform value-based pricing negotiations. Manufacturers may consider outcomes-based pricing agreements where reimbursement tiers align with demonstrated enzyme restoration levels and sustained eGFR stability.

## B. Cost and QALY Decomposition

**Cost-Effectiveness Plane.** The cost-effectiveness plane plots incremental costs against incremental QALYs for each scenario (Figure 1; data available in Models/Lowe_HTA/ce_plane_data.csv). Scenario 1 (50% enzyme) demonstrates the most favorable incremental cost-effectiveness ratio at €241,480 per QALY with 8.11 QALYs gained for €1.96M incremental cost. Scenario 2 (30% enzyme) shows intermediate cost-effectiveness at €379,477 per QALY with 5.83 QALYs for €2.21M. Scenario 3 (15% enzyme) exhibits poor cost-effectiveness at €1.16M per QALY, positioned in the northeast quadrant with high costs (€2.75M) and modest QALY gains (2.37). All three scenarios fall in the cost-effective region (northeast quadrant) relative to natural history origin, but vary substantially in their incremental cost-effectiveness ratios.
