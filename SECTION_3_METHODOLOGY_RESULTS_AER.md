...
**Scenario 1: Optimistic - Carrier-Equivalent Kidney Protection (θ = 1.0).** See Section II.D for detailed scenario specification. This scenario generates 6.91 incremental QALYs (12.76 equal-value life years gained) and 16.4 additional life years relative to natural history, with complete ESKD prevention (patients never reach ESKD within lifetime).
...
**Scenario 2: Realistic - Good Biodistribution (θ = 0.85, BASE CASE).** See Section II.D for detailed scenario specification. Treatment generates 2.56 QALYs (4.73 evLYG) and 5.3 life years gained, delaying ESKD by 52 years (from age 32 to age 84). Maximum justifiable prices are **€528,000** at €100K/QALY, **€656,000** at €150K/QALY, and **€1,041,000** at €300K/QALY.

**Scenario 3: Conservative - Moderate Biodistribution (θ = 0.70).** See Section II.D for detailed scenario specification. This yields 0.67 QALYs (1.24 evLYG) and 1.3 life years gained, delaying ESKD by 31 years (from age 32 to age 63). Maximum prices are **€0** at €100K/QALY (below cost-effectiveness threshold), **€27,000** at €150K/QALY, and **€127,500** at €300K/QALY.
