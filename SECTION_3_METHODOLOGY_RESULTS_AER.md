...
OCRL deficiency affects multiple organ systems, causing intellectual disability (90% prevalence, typically moderate with mean IQ 50-70), congenital cataracts and progressive ophthalmologic disease (100%), neurological abnormalities including hypotonia and behavioral problems (100%), and musculoskeletal complications in addition to progressive nephropathy (Lowe et al. 1952; Bökenkamp & Ludwig 2016). The proposed AAV-mediated gene therapy targets kidney tissue specifically and is not expected to achieve therapeutic OCRL expression in the central nervous system or eye due to AAV serotype tropism and blood-brain barrier limitations. This raises a fundamental question for health technology assessment: should a therapy that treats only one manifestation of a multi-organ syndrome be considered cost-effective?
...
We model mortality from two sources: background mortality and CKD-related excess mortality. Background mortality rates m_t^{bg} follow United States life tables adjusted for male sex (Arias and Xu 2022). CKD-related excess mortality varies by health state, with relative risk ratios derived from large cohort studies of CKD progression (Go et al. 2004; Tonelli et al. 2006). Let m_{s,t} denote the annual mortality probability for a patient in health state *s* at age *t*. We specify:
