...
In this section we seek to address the question of reimbursement for a kidney-directed gene therapy for Lowe syndrome. 
...
Cost-effectiveness of AAV-based gene therapy for Lowe syndrome hinges on modeling of lifelong disease progression, treatment effects, and economic consequences across multiple chronic kidney disease stages from initial therapy administration through end-stage kidney disease or death (Drummond et al. 2015; Neumann et al. 2016). The analysis employs a discrete-time Markov cohort model simulating disease progression through six health states defined by estimated glomerular filtration rate thresholds according to Kidney Disease: Improving Global Outcomes guidelines (KDIGO 2012), comparing gene therapy to natural history without disease-modifying treatment from a healthcare system perspective over a lifetime time horizon with 1.5 percent annual discounting as primary analysis (NICE non-reference case for curative therapies) and 3.5 percent reference case in sensitivity analysis (NICE 2022; Sanders et al. 2016). Model structure, clinical parameters, cost inputs, and utility weights synthesize evidence from Section I natural history findings with published cost-effectiveness literature for chronic kidney disease interventions (Cooper et al. 2020; Wyld et al. 2012) and recent ultra-rare disease gene therapy economic evaluations (ICER 2019; NICE 2022).

## A. Scope and Justification: Kidney-Focused Treatment of a Multi-Organ Disease

OCRL deficiency affects multiple organ systems, causing intellectual disability, congenital cataracts and in some cases progressive ophthalmologic disease, neurological abnormalities including hypotonia and behavioral problems, and musculoskeletal complications in addition to progressive nephropathy (Lowe et al. 1952; Bökenkamp & Ludwig 2016). The proposed AAV-mediated gene therapy targets kidney tissue specifically and is not expected to achieve therapeutic OCRL expression in the central nervous system or eye due to AAV serotype tropism and blood-brain barrier limitations. This raises a question for health technology assessment: should a therapy that treats only one manifestation of a multi-organ syndrome be considered cost-effective?

We argue that renal-specific gene therapy merits favorable economic evaluation for three reasons. First, kidney disease drives mortality in Lowe syndrome despite substantial morbidity from neurodevelopmental and ophthalmologic manifestations. Retrospective cohort studies identify renal failure as the primary cause of premature death (Murdock et al. 2023; Ando et al. 2024), with median ESKD onset at age 32 and post-ESKD survival averaging 5-6 years in natural history. Preventing premature death from kidney failure has intrinsic value independent of improvements in other organ systems, following the established principle that mortality-reducing interventions justify reimbursement even when not addressing all disease manifestations.

Second, our model applies conservative quality-of-life adjustments that explicitly account for untreated manifestations. Rather than assuming gene therapy restores patients to full health, we apply a Lowe syndrome-specific utility multiplier of 0.85 (15% reduction) to all health states throughout the lifetime horizon. This multiplier captures the persistent burden of intellectual disability, vision loss, and neurological symptoms that gene therapy does not treat. For example, a patient with CKD Stage 2 following successful gene therapy receives utility weight 0.61 rather than the base CKD population value of 0.72, reflecting ongoing non-renal morbidity. This approach deliberately penalizes the economic model for treating only kidney disease, ensuring we do not overstate treatment value by ignoring untreated manifestations.

Third, precedent from other multi-organ genetic diseases supports reimbursement of therapies addressing mortality-driving manifestations without requiring treatment of all disease features. Health technology assessment bodies routinely approve such interventions: enzyme replacement therapy for Fabry disease improves cardiac and renal outcomes while cerebrovascular and pain manifestations incompletely respond; CFTR modulators for cystic fibrosis primarily improve pulmonary function as pancreatic insufficiency persists; antisense oligonucleotide therapy for Duchenne muscular dystrophy targets skeletal muscle but not cardiac involvement. These therapies receive reimbursement because they successfully address life-threatening organ involvement despite constituting "partial treatments" of multi-system disorders. Lowe syndrome gene therapy follows this established precedent by preventing lethal renal failure while acknowledging that neurodevelopmental and ophthalmologic manifestations remain untreated.

The modeling approach reflects this partial treatment reality through dual metric reporting. We report both incremental cost per quality-adjusted life year ($/QALY) and cost per life year gained ($/LYG) to provide complete transparency. The $/QALY metric appropriately applies quality adjustments for a multi-organ disease where only one organ system responds to treatment, aligning with health technology assessment standards. The $/LYG metric demonstrates the magnitude of survival benefit from preventing lethal renal failure. In our base case realistic scenario, these yield $/QALY of $327,070 (approaching the €300,000 threshold for ultra-rare diseases under NICE Highly Specialised Technologies framework) and $/LYG of $106,652 (well below typical willingness-to-pay thresholds). The discrepancy between these metrics reflects genuine quality-of-life burden from untreated neurodevelopmental and ophthalmologic symptoms rather than a modeling limitation. Both perspectives demonstrate favorable cost-effectiveness, supporting reimbursement consideration within established frameworks for ultra-rare, life-threatening genetic diseases.

## B. Synthesis of Natural History Evidence

The modeling approach integrates key findings from Section I regarding disease natural history, treatment effect expectations, and economic burden. Longitudinal studies demonstrate progressive kidney function decline in Lowe syndrome with marked age-dependent acceleration. Ando et al. (2024) report median ESKD onset at age 32 in a Japanese cohort (n=54), with Figure 1B revealing three distinct progression phases: slow decline (~1.0 ml/min/year) in early childhood (ages 1-9), steep acceleration (~3.5 ml/min/year) during adolescence (ages 10-19), and moderate decline (~2.0 ml/min/year) in adulthood (ages 20+). Zaniew et al. (2018) document strong age-dependent eGFR decline (r=-0.80, p<0.001) in an international cohort (n=88). We calibrate the model with starting eGFR 83 ml/min/1.73m² at age 1 and age-varying decline rates to achieve median ESKD onset at age 32 (see Section II.E for detailed calibration methodology).

Carrier biology provides the biological anchor for treatment effect scenarios. Female carriers with approximately 50% enzyme activity typically remain free of progressive kidney disease, establishing proof-of-concept that partial enzyme restoration prevents nephropathy (see Section II.E Scenario 1 for detailed carrier evidence). Our primary scenario models carrier-equivalent kidney protection (0.30 ml/min/1.73m²/year decline from normal aging only). Alternative scenarios test intermediate and minimal protection, reflecting uncertainty in whether gene therapy will achieve carrier-equivalent outcomes.

Lowe syndrome patients experience substantial quality-of-life burden beyond kidney disease. Intellectual disability (90% prevalence), severe visual impairment (100%), and neurological complications affect all patients independent of kidney function (Section I.C). Standard CKD utility values from general populations (Wyld et al. 2012) do not capture this additional burden. We therefore apply a 0.85 multiplier to CKD utilities, representing a 15% decrement for Lowe syndrome-specific manifestations throughout all health states and across the lifetime horizon.

Section I documented substantial healthcare resource utilization in Lowe syndrome natural history, with lifetime costs estimated at €2.5-3.5 million per patient. These costs concentrate heavily in ESKD years where dialysis alone costs €150,000 annually. Prevention or delay of ESKD progression represents the primary source of economic value for gene therapy, as treatment shifts patients from high-cost ESKD states to lower-cost CKD management while extending survival.

## C. Markov Cohort Model Framework

Evaluating gene therapy cost-effectiveness requires projecting outcomes over a liftime which goes far beyond any feasible clinical trial duration. Fundamentally, we cannot observe how a treated child will fare at age 70. Instead, we build a simulation model that combines what we know about disease progression, treatment effect scenarios, costs, and quality of life to project lifetime outcomes. The model tracks a hypothetical group of patients as they age, moving through progressive stages of kidney disease based on their eGFR levels. Each year, the model calculates how many patients remain in each stage, what medical costs they incur, and what quality of life they experience. By comparing the treated group's trajectory to an untreated group, we quantify the clinical benefit (extra years of life, improved quality) and economic cost (therapy price plus ongoing care), yielding the cost per quality-adjusted life year gained.

We employ a discrete-time Markov cohort model as the analytical framework. Markov models represent the standard approach for chronic progressive diseases where patients transition through discrete health states over time (Sonnenberg and Beck 1993; Briggs and Sculpher 1998). This modeling paradigm proves particularly well-suited for Lowe syndrome nephropathy given the disease's characteristic features: irreversible progressive decline in kidney function, well-defined clinical staging based on eGFR thresholds, and state-dependent costs and quality of life.

The fundamental Markov assumption posits that transition probabilities between health states depend only on the current state, not on the path by which patients reached that state—the "memoryless" property (Beck and Pauker 1983). For chronic kidney disease, this assumption holds reasonably well. A patient's risk of progressing from CKD Stage 3b to Stage 4 depends primarily on their current eGFR level and decline rate, not whether they previously experienced rapid or gradual progression through earlier stages. While eGFR trajectory history may contain prognostic information in reality, the discrete staging system based on current eGFR captures the clinically relevant stratification for treatment and cost allocation.

Let **M**(t) denote the Markov model state distribution vector at cycle t, where M_s(t) represents the proportion of the cohort occupying health state s ∈ {CKD2, CKD3a, CKD3b, CKD4, ESKD, Death}. The model evolves according to the matrix equation:
...
Total discounted lifetime costs and quality-adjusted life years are calculated via accumulation across all cycles and states:

(2)    Total Cost = Σ_t Σ_s M_s(t) × C_s × (1 + r)^(−t)

(3)    Total QALYs = Σ_t Σ_s M_s(t) × U_s × (1 + r)^(−t)

where C_s denotes the annual cost incurred in state s, U_s the utility weight (QALY value) for state s, and r the annual discount rate (1.5% primary analysis, 3.5% reference case). These equations implement the standard half-cycle correction implicitly by assigning state-specific costs and utilities at the beginning of each cycle.
...
The model operates with annual cycles and six mutually exclusive health states defined by kidney function. We track a cohort of 1,000 Lowe syndrome patients from age 1 until death, accumulating costs and quality-adjusted life years (QALYs) over the lifetime horizon. The six health states are defined by estimated glomerular filtration rate (eGFR) following Kidney Disease: Improving Global Outcomes (KDIGO) guidelines (KDIGO 2012):
...
Disease progression is governed by annual eGFR decline. Let eGFR_t denote kidney function at time *t*, measured in ml/min/1.73m². The evolution of kidney function follows:
...
We model mortality from two sources: background mortality and Lowe syndrome-specific excess mortality. Background mortality rates m_t^{bg} follow Danish (Danmarks Statistik) life tables for males, representing age-specific mortality in the general population. Lowe syndrome excess mortality varies by CKD health state and is derived directly from natural history calibration rather than general population CKD studies. Let m_{s,t} denote the annual mortality probability for a patient in health state *s* at age *t*. We specify:

(2)    m_{s,t} = m_t^{bg} × RR_s

where RR_s is the Lowe syndrome-specific relative risk multiplier for health state *s*. This formulation is mathematically equivalent to the additive model m_{s,t} = m_t^{bg} + (RR_s - 1) × m_t^{bg}, explicitly separating background and excess mortality components.

The relative risk multipliers are calibrated to match established Lowe syndrome natural history endpoints: (1) progression to ESKD at approximately age 32 years (Ando et al. 2024), and (2) median survival in the second to fourth decade of life, ages 20-40 (Murdock et al. 2023). The resulting relative risks are substantially elevated compared to general CKD populations, reflecting the multi-organ disease burden characteristic of Lowe syndrome including neurological complications (intellectual disability in 90%, seizure disorders), complete ophthalmologic impairment (congenital cataracts in 100%, progressive glaucoma), and increased infection susceptibility. Our calibrated relative risks are RR_2 = 15, RR_{3a} = 30, RR_{3b} = 50, RR_4 = 80, and RR_{ESKD} = 120, demonstrating mortality risk that far exceeds isolated renal disease. 

## E. Clinical Parameters

We parameterize natural history progression using published longitudinal data on kidney function in Lowe syndrome. Ando et al. (2024) report a Japanese nationwide cohort of 54 patients demonstrating strong age-dependent eGFR decline (r = -0.80, p < 0.001), with median ESKD onset at age 32. Visual inspection of Ando Figure 1B reveals three distinct progression phases with different decline rates: slow early childhood decline (ages 1-10), steep adolescent acceleration (ages 10-20), and moderate adult decline (ages 20+). This age-dependent heterogeneity motivates our use of an age-varying decline framework rather than a single constant rate.
...
We calibrate the starting eGFR (eGFR₀ at age 1) and age-specific decline rates to achieve median ESKD onset at age 32, as reported by Ando et al. (2024). The recalibrated model parameters are:
...
Systematic reviews of healthy populations without hypertension or diabetes report normal eGFR decline of 0.8–1.1 ml/min/1.73 m²/year in adults (Waas et al. 2021; Guppy et al. 2024; Baba et al. 2015; Cohen et al. 2014). This physiological decline begins in the third or fourth decade and continues throughout life. Critically, in healthy children and young adults (ages 1-25), eGFR remains stable or increases with growth—the 0.8-1.1 ml/min/year decline reflects adult aging. Since Lowe syndrome patients progress from age 1 to ESKD at age 32, the majority of disease progression occurs during years when normal aging contributes minimally to eGFR decline. For modeling purposes, we approximate δ_age ≈ 0.3 ml/min/1.73m²/year averaged over ages 1-40, representing minimal decline in childhood (0 ml/min/year) transitioning to adult aging rates (0.8-1.1 ml/min/year) in later years.

Subtracting the aging component from natural history rates yields the age-specific pathological decline:
...
Gene therapy aims to reduce pathological decline by factor θ (0 ≤ θ ≤ 1):
...
We designate **Scenario 2 (θ = 0.85, eliminating 85% of pathological decline) as the BASE CASE** for economic evaluation. The θ = 0.85 parameter represents a realistic expectation for AAV-based kidney gene therapy, balancing optimism about achieving substantial OCRL restoration with conservatism about technical challenges including liver vector sequestration, modest renal tropism of current capsids, and potential immune responses. This assumption reflects high but not perfect vector transduction efficiency in proximal tubule cells, sustained transgene expression without significant waning, and absence of neutralizing antibodies. To bracket uncertainty around this central estimate, we model one optimistic scenario (Scenario 1: θ = 1.0, carrier-equivalent kidney protection) and two pessimistic scenarios (Scenario 3: θ = 0.70, moderate biodistribution; Scenario 4: θ = 0.50, suboptimal biodistribution). All clinical outcomes and cost-effectiveness results in Section III derive from Scenario 2 unless otherwise specified.

### Scenario 1: Optimistic - Carrier-Equivalent Kidney Protection

As established in Section II.B, carrier biology provides the biological anchor for this scenario: female carriers expressing approximately 50% OCRL enzyme activity typically maintain normal kidney function throughout life (Röschinger et al. 2000; Bökenkamp & Ludwig 2016), establishing proof-of-concept that partial enzyme restoration can achieve complete kidney protection.

Scenario 1 models the optimistic outcome wherein gene therapy achieves carrier-equivalent kidney protection (θ = 1.0), completely eliminating pathological decline. This assumes the therapy delivers ≥50% OCRL enzyme activity in kidney proximal tubule cells, matching the heterozygous carrier phenotype.

Under this scenario, time-averaged decline rate reaches only 0.30 ml/min/1.73m²/year, representing normal aging decline alone (δ_age from equation 9). Treated patients experience age-varying decline rates of:
...
This scenario produces complete ESKD prevention, with patients never reaching ESKD within the 100-year time horizon. Life expectancy extends to 62.6 years versus 37.5 years under natural history, yielding 25.1 additional life years. Quality-adjusted life years gained reach 8.21 QALYs (discounted at 1.5%). Cost-effectiveness achieves $309,300/QALY or $101,213 per life year gained.

This outcome requires excellent vector biodistribution to kidney tissue, high transduction efficiency in renal proximal tubule cells, sustained transgene expression, and absence of immune-mediated clearance. Systemic AAV administration faces kidney-specific challenges including preferential liver capture (60-80% of vector; Nathwani et al. 2014) and modest renal tropism of current capsids (Lisowski et al. 2014). Scenario 1 represents best-case technical success.

### Scenario 2: Realistic - Good Biodistribution (BASE CASE)

Scenario 2 models the realistic base case outcome wherein gene therapy achieves substantial kidney protection (θ = 0.85), eliminating 85% of pathological decline. This represents a realistic expectation for AAV-mediated kidney gene therapy with successful but imperfect biodistribution and good vector targeting.

Time-averaged decline rate reaches 0.52 ml/min/1.73m²/year, primarily reflecting normal aging with a residual pathological component. Using decomposition equation (11) with θ = 0.85, treated patients experience age-varying decline rates of:
...
This base case scenario prevents ESKD within patients' lifetimes, with no progression to ESKD by age 100. Life expectancy extends to 61.6 years versus 37.5 years under natural history, yielding 24.1 additional life years. Quality-adjusted life years gained reach 7.86 QALYs (discounted at 1.5%).

### Scenario 3: Conservative - Moderate Biodistribution

Scenario 3 models a conservative outcome wherein gene therapy achieves moderate kidney protection (θ = 0.70), eliminating 70% of pathological decline. This scenario represents suboptimal but meaningful biodistribution, with some proximal tubule regions under-treated.

Time-averaged decline rate reaches 0.74 ml/min/1.73m²/year, reflecting normal aging plus a residual pathological component. Using decomposition equation (11) with θ = 0.70, treated patients experience age-varying decline rates of:
...
Starting from eGFR₀ = 95 ml/min/1.73m² at age 1, patients maintain good kidney function and avoid ESKD within the 100-year horizon, though progression is faster than the base case scenario (Figure 2).

This conservative scenario still prevents ESKD within patients' lifetimes, with no ESKD by age 100. Life expectancy extends to 56.4 years versus 37.5 years under natural history, yielding 18.9 additional life years. Quality-adjusted life years gained reach 6.48 QALYs (discounted at 1.5%). Cost-effectiveness achieves $413,893/QALY or $142,244 per life year gained.

This outcome could result from moderate vector transduction efficiency, suboptimal capsid selection for kidney targeting, or partial immune-mediated clearance reducing sustained expression. While ICER exceeds the €300K threshold, it remains within the range considered for ultra-rare life-threatening diseases (€300K-500K/QALY). Cost per life year gained ($142K) remains highly favorable.

### Scenario 4: Pessimistic - Suboptimal Biodistribution

Scenario 4 models a pessimistic outcome wherein gene therapy provides limited kidney protection (θ = 0.50), eliminating only 50% of pathological decline. This scenario represents poor biodistribution or limited transduction of critical renal cell populations.

Time-averaged decline rate reaches 1.04 ml/min/1.73m²/year, reflecting substantial residual pathological decline. Using decomposition equation (11) with θ = 0.50, treated patients experience age-varying decline rates of:
...
Starting from eGFR₀ = 95 ml/min/1.73m² at age 1, patients progress more rapidly through CKD stages but still avoid ESKD within the 100-year horizon (Figure 2).

This pessimistic scenario still prevents ESKD within patients' lifetimes, though patients barely avoid ESKD by age 100. Life expectancy extends to 48.3 years versus 37.5 years under natural history, yielding 10.8 additional life years. Quality-adjusted life years gained reach 4.13 QALYs (discounted at 1.5%). Cost-effectiveness achieves $689,209/QALY or $263,663 per life year gained.

This scenario represents lower-bound efficacy expectations. It could result from poor renal vector tropism (preferential liver capture), inadequate vector dosing, immune responses, or failure to transduce critical proximal tubule populations. While ICER exceeds typical thresholds, the substantial survival benefit (11 years) and favorable cost per life year gained ($264K) suggest meaningful clinical value even in this worst-case scenario. Treatment effects below θ = 0.50 would represent treatment failure and are not modeled in this analysis.
...
These utilities derive from general CKD populations without intellectual disability or visual impairment. Lowe syndrome patients experience substantial additional quality-of-life impacts from neurological and ocular manifestations present regardless of kidney function. To account for these disease-specific burdens, we derive Lowe syndrome utility decrements from published literature on visual impairment and intellectual disability. Congenital cataracts, glaucoma, and severe visual impairment (present in 100% of patients) reduce health-related quality of life by 0.10-0.15 utility points based on EQ-5D valuations for severe vision loss (Hanemoto et al. 2006; Brown et al. 2001). Intellectual disability (mean IQ 50-70, present in 90% of patients) independently reduces utilities by 0.05-0.10 points based on caregiver-reported quality of life measures for developmental disorders (Penner et al. 2013; Kuhlthau et al. 2010). Combined, these manifestations justify a multiplicative decrement of 0.85 (15% reduction) applied to base CKD utilities across all health states. This approach captures the additive burden of Lowe syndrome-specific features while preserving the relative differences between CKD stages. Under the maintained assumption that these non-progressive features affect both treatment and control arms equally, our utility mapping provides unbiased estimates of incremental QALYs attributable to kidney function preservation. We examine alternative specifications (0.85 to 0.95 multipliers) in sensitivity analysis.

This approach captures direct patient quality-of-life burden but substantially underestimates total societal burden. Caregiver burden for Lowe syndrome families is considerable, with parents providing extensive daily assistance for activities of daily living, managing multiple specialist appointments, and addressing behavioral challenges associated with intellectual disability. Published estimates suggest caregiver disutilities of 0.10-0.20 for rare pediatric conditions with similar care intensity (Tilford et al. 2012; Prosser et al. 2015), which we exclude from the base case analysis per NICE reference case guidelines emphasizing patient perspective. Including family caregiver burden would increase incremental QALYs gained from treatment, further improving cost-effectiveness ratios.
...
To facilitate comparison across diseases with different baseline quality of life, we calculate equal-value life years gained (evLYG) as a supplementary metric (Lakdawalla et al. 2021; Basu and Carlson 2022). evLYG converts incremental QALYs into an equivalent number of life years lived at a reference utility level:
...
Model parameters were calibrated to reproduce key natural history outcomes: ESKD onset at age 32 (Ando et al. 2024) and life expectancy of 37.5 years (consistent with published range of 30-45 years; Bökenkamp and Ludwig 2016; Ando et al. 2024). The calibrated age-varying decline rates achieve these targets without requiring additional post-hoc adjustments, suggesting the three-phase decline framework (1.0, 3.0, 1.5 ml/min/yr) accurately captures disease progression.

We verified several internal model checks to ensure structural validity. Cohort conservation was confirmed, with state proportions summing to 1.0 ± 10⁻¹² each cycle. Monotonicity held across scenarios, with improved treatment scenarios yielding strictly better outcomes (higher QALYs, longer survival, delayed ESKD). Extreme value behavior performed as expected, with zero decline producing maximum QALYs and infinite decline producing minimum. The model structure, parameterization approach, and utility patterns align with published CKD Markov models in the health economics literature (Ruggeri et al. 2014; Cooper et al. 2020). External validation against independent patient cohorts would strengthen confidence in projections but is not feasible given the rarity of Lowe syndrome. Formal probabilistic sensitivity analysis with parameter uncertainty propagation is planned for final peer-reviewed publication.
...
## C. Treatment Timing Analysis

The base case analysis assumes gene therapy administration at age 1, reflecting early diagnosis through newborn screening or clinical presentation in infancy. However, treatment timing varies in clinical practice due to diagnostic delays, family decision-making, vector manufacturing lead times, and institutional protocols. We examine how cost-effectiveness varies with treatment age using the realistic base case scenario (θ = 0.85, eliminating 85% of pathological decline) across ages 0 through 10 years.

Treatment timing affects cost-effectiveness through multiple mechanisms. First, delaying treatment allows irreversible kidney damage to accumulate before therapy initiation. Under natural history, eGFR declines by approximately 1.0 ml/min/1.73m²/year during ages 1-10 (equation 8, Section II.E). A child treated at age 5 has already experienced 4 years of untreated decline (4 ml/min/1.73m² cumulative loss) compared to treatment at age 1, starting from a lower baseline eGFR (91 vs 95 ml/min/1.73m²). This reduces the remaining disease runway and shortens time to ESKD even with effective treatment. Second, delayed treatment reduces the number of life years gained. A patient treated at age 1 who lives to age 62 gains 24 life years versus natural history (37.5 years); the same patient treated at age 6 gains only 19 life years (lives to age 57) because 5 years of untreated progression occurred before intervention. Third, treatment costs remain constant regardless of timing (€2.85 million for acquisition plus monitoring), but life years gained decrease with delay, mechanically worsening the incremental cost-effectiveness ratio.

Table 3 presents cost-effectiveness outcomes across treatment ages 0-10 for the base case realistic scenario (Scenario 2: θ=0.85). Results demonstrate substantial degradation in cost-effectiveness with delayed treatment. Treatment at birth (age 0) yields the most favorable ICER at $318,000/QALY, with 8.12 QALYs gained and 24.9 life years extended. Treatment at age 1 (base case) produces ICER $327,000/QALY with 7.86 QALYs and 24.1 life years gained. Cost-effectiveness deteriorates progressively with delay: age 3 yields ICER $355,000/QALY (7.21 QALYs, 22.1 LYs), age 5 reaches $396,000/QALY (6.48 QALYs, 19.7 LYs), and age 10 exceeds $550,000/QALY (4.67 QALYs, 14.2 LYs).

The relationship between treatment age and ICER displays approximately linear degradation over ages 0-7 (ICER increases ~$12,000 per year of delay) followed by accelerated deterioration beyond age 7 (ICER increases ~$25,000-30,000 per year of delay after age 7). This nonlinearity reflects the age-varying decline framework: children aged 1-10 experience slow pathological decline (δ_path = 0.7 ml/min/yr), but adolescents aged 10-20 face steep acceleration (δ_path = 2.7 ml/min/yr). Patients treated at ages 8-9 approach the adolescent acceleration phase more rapidly than those treated earlier, amplifying the penalty for delayed treatment as they enter the steepest decline period with less functional reserve. A patient treated at age 9 reaches age 10 (adolescent acceleration onset) with only 1 year of treatment-mediated protection, whereas a patient treated at age 1 has 9 years of preserved kidney function before facing the adolescent challenge.

**Clinical and Policy Implications.** These findings support prioritizing early treatment initiation for Lowe syndrome gene therapy. Cost-effectiveness remains acceptable (below €400,000/QALY) for treatment administered through age 4-5, providing reasonable flexibility for diagnostic confirmation, family counseling, and treatment preparation without critically compromising economic value. However, delays beyond age 6-7 substantially worsen cost-effectiveness, approaching or exceeding €500,000/QALY—the upper bound considered by NICE for highly specialized technologies in ultra-rare diseases. From a clinical perspective, treatment before age 5 maximizes benefit by preserving kidney function through the slow early childhood decline phase and establishing therapeutic protection before adolescent acceleration (ages 10-20) when pathological decline reaches 2.7 ml/min/yr.

**Newborn Screening Considerations.** Treatment at birth (age 0) yields marginally better cost-effectiveness than age 1 (ICER difference ~$9,000/QALY), representing a 3% improvement. This modest gain reflects two offsetting factors: earlier treatment prevents slightly more cumulative decline (gaining ~1 additional year of normal kidney function), but front-loading treatment costs by 1 year incurs discounting penalties that partially offset clinical benefit gains. The limited economic advantage of birth treatment (age 0) versus early infancy treatment (age 1-2) suggests that universal newborn screening may not be economically justified solely on treatment timing grounds. However, newborn screening could provide value through other mechanisms not captured in this analysis: enabling carrier detection for family planning, facilitating early nephrology and ophthalmology care, and supporting accurate natural history data collection.

**Delayed Diagnosis and Treatment Access Barriers.** The steep degradation in cost-effectiveness with delayed treatment raises concerns about real-world treatment access. Lowe syndrome diagnosis often occurs at ages 2-4 rather than infancy due to nonspecific early presentations and diagnostic delays (Bökenkamp & Ludwig 2016). Vector manufacturing for ultra-rare disease gene therapies requires 3-6 months from patient enrollment to product availability, adding further delay between diagnosis and treatment. Socioeconomic barriers and insurance approval processes may introduce additional delays. Our analysis suggests that health systems should implement expedited pathways for Lowe syndrome gene therapy access following diagnosis to minimize the treatment timing penalty. For patients diagnosed at ages 6-8, remaining cost-effectiveness (ICERs $450,000-500,000/QALY) approaches but does not clearly exceed ultra-rare disease thresholds, supporting case-by-case evaluation rather than categorical age cutoffs for eligibility.

**Comparison to Other Pediatric Gene Therapies.** The treatment timing sensitivity observed in Lowe syndrome aligns with findings from other pediatric gene therapies for progressive genetic diseases. Spinal muscular atrophy gene therapy (Zolgensma) demonstrates marked outcome differences between presymptomatic treatment (near-normal motor function) and treatment after symptom onset (variable gains dependent on disease severity at treatment). Inherited retinal disease gene therapy (Luxturna) achieves better visual outcomes when administered before extensive photoreceptor degeneration. These parallels reinforce the principle that curative genetic therapies for progressive childhood diseases maximize value through early intervention before irreversible organ damage accumulates.

**Figure 3: Cost-Effectiveness by Treatment Age.** [Heatmap visualization showing ICER ($/QALY) on y-axis from $300,000 to $600,000, treatment age (years) on x-axis from 0 to 10, with color gradient from green (favorable) to red (unfavorable). Threshold lines marked at €300K, €400K, and €500K/QALY for reference.]
