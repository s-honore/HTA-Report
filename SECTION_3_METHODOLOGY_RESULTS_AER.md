...
This section evaluates whether gene therapy for Lowe syndrome would be worth its cost from a healthcare system perspective. Lowe syndrome is an ultra-rare genetic disease affecting approximately 1 in 500,000 births, caused by mutations in the OCRL gene. Boys with Lowe syndrome develop progressive kidney failure, typically reaching end-stage kidney disease (ESKD) requiring dialysis at age 32, with life expectancy around 42 years. Gene therapy aims to deliver a functional copy of the OCRL gene to restore missing enzyme activity and prevent kidney disease progression.

We built a computer model that simulates the lifetime journey of Lowe syndrome patients—tracking kidney function decline, medical costs, quality of life, and survival—comparing gene therapy to the natural course of untreated disease. The analysis answers two fundamental questions: (1) How much health benefit (measured in quality-adjusted life years, or QALYs) could gene therapy provide? (2) What is the maximum justifiable price for gene therapy given these health benefits?

## Why This Matters

Gene therapies cost millions of dollars per patient, and Lowe syndrome affects very few patients worldwide (~150 living patients in the US, ~500 globally). Healthcare systems must decide whether to pay for these expensive treatments and manufacturers must determine appropriate pricing. This analysis provides evidence-based guidance for these decisions by quantifying the clinical value of preventing kidney disease and extending life in Lowe syndrome.

The analysis is particularly timely because several gene therapy programs for Lowe syndrome are in preclinical or early clinical development. Our findings can inform clinical trial design (what endpoints to measure, what level of kidney function preservation constitutes success) and pricing negotiations between manufacturers and payers once these therapies reach the market.

## Key Findings

**Clinical Outcomes:** If gene therapy achieves carrier-equivalent kidney protection—meaning treated patients experience only normal age-related kidney decline, similar to female carriers who have 50% enzyme activity and typically don't develop kidney disease—patients would gain 16.4 additional life years (living to age 59 instead of age 42) and 6.9 quality-adjusted life years. They would never reach end-stage kidney disease within their lifetime, avoiding decades of dialysis.

Under less optimistic scenarios where gene therapy provides only partial kidney protection, benefits are substantially smaller: intermediate protection yields 5.3 additional life years and 2.6 QALYs, while minimal protection yields just 1.3 life years and 0.7 QALYs.

**Economic Value:** Using value-based pricing—where we solve for the maximum price that achieves standard cost-effectiveness thresholds—the carrier-equivalent scenario supports gene therapy prices up to €3.0 million at the €300,000 per QALY threshold used for ultra-rare diseases (comparable to approved gene therapies like Hemgenix at €3.5M). However, this value drops steeply with reduced efficacy: intermediate protection supports only €1.0 million maximum price, and minimal protection supports just €128,000.

**Critical Uncertainty:** The analysis reveals that treatment success hinges on achieving carrier-equivalent kidney protection. The incremental cost-effectiveness ratio (ICER) for carrier-equivalent protection is €298,264 per QALY—within acceptable thresholds for ultra-rare diseases—but jumps to €1,064,156 per QALY for intermediate protection and €4,589,819 per QALY for minimal protection, making these scenarios unlikely to meet conventional cost-effectiveness standards.

## What We Modeled

We simulate three scenarios reflecting uncertainty in treatment effectiveness, characterized by different kidney function decline rates measured as estimated glomerular filtration rate (eGFR):

1. **Carrier-Equivalent Protection (0.30 ml/min/1.73m²/year decline):** Gene therapy achieves full kidney protection comparable to female carriers. Patients experience only normal age-related kidney decline (~0.3 ml/min/year), avoiding all pathological decline from OCRL deficiency (~0.8 ml/min/year). This represents complete elimination of disease-related kidney damage.

2. **Intermediate Protection (0.70 ml/min/1.73m²/year decline):** Gene therapy provides substantial but incomplete kidney protection. Patients experience 50% reduction in disease-related kidney decline, delaying but not preventing ESKD (which occurs at age 84 instead of age 32).

3. **Minimal Protection (0.94 ml/min/1.73m²/year decline):** Gene therapy provides limited kidney protection, reducing disease progression by only 20%. ESKD is modestly delayed to age 63 (versus age 32 untreated), but patients still experience severe kidney disease.

These scenarios are not based on dose-response data linking specific enzyme restoration levels to specific kidney outcomes—no such data exist. Instead, they represent plausible ranges of clinical benefit anchored by carrier biology (which proves that carrier-equivalent protection is biologically achievable) and bounded by natural history (which defines the worst-case untreated outcome).

## How the Analysis Works

We use a Markov cohort model, a standard approach in health economics for chronic progressive diseases. The model tracks a hypothetical cohort of 1,000 Lowe syndrome patients from age 5 (typical treatment age) through their entire lifespan, simulating progression through six kidney disease stages: CKD Stage 2 (mild), 3a (mild-moderate), 3b (moderate), 4 (severe), ESKD (kidney failure requiring dialysis), and Death. Each year, patients move between stages based on their kidney function decline rate, accumulating medical costs and quality-of-life impacts specific to their disease stage.

We calibrated the model using published natural history data from Japanese and international Lowe syndrome cohorts showing median ESKD onset at age 32. The model reproduces this observed progression: starting with eGFR of 70 ml/min/1.73m² at age 5 and declining at 1.10 ml/min/year, patients reach ESKD at year 27 (age 32) and die at age 42, matching published survival data.

**Importantly, we decompose total kidney decline into two components:** normal aging (D_age ≈ 0.3 ml/min/year, averaged over ages 5-40) and pathological disease-related decline (D_path ≈ 0.8 ml/min/year). Gene therapy affects only the pathological component; it cannot slow aging. This mathematical framework—expressed as D_treated = D_age + (1-θ)×D_path where θ is the treatment effect—ensures biological plausibility. A treatment that eliminates all disease-related decline (θ=1.0) still allows normal aging to occur.

We apply a 1.5% annual discount rate to both costs and health benefits, as justified under NICE guidelines for curative therapies that restore patients to near-full health with sustained long-term benefits. This lower discount rate (versus the standard 3.5% reference case) appropriately values future health gains for one-time curative interventions with lifelong effects.

## Limitations and Uncertainties

This analysis relies on several assumptions that may not hold in practice:

- **No clinical trial data exist:** All scenarios are based on modeling assumptions, not observed treatment effects. We don't know if gene therapy will actually achieve carrier-equivalent protection or any level of kidney benefit.
- **Durability assumption:** We assume gene therapy provides lifelong benefit without waning, based on 10+ year durability data from other AAV gene therapies in liver-directed applications. Kidney-specific durability may differ.
- **Surrogate endpoint:** We model kidney function (eGFR) as the primary outcome, assuming eGFR decline predicts ESKD and survival. While strongly supported by chronic kidney disease literature, this relationship has not been validated specifically in Lowe syndrome.
- **Quality of life assumptions:** We apply general chronic kidney disease utility values (with a 15% penalty for Lowe-specific manifestations like intellectual disability and vision loss) because no Lowe syndrome-specific quality-of-life data exist.
- **No safety concerns:** The model assumes no significant adverse events, immunotoxicity, or off-target effects from gene therapy. Real-world outcomes could be worse if safety issues emerge.

Despite these limitations, the analysis provides valuable decision-relevant evidence by quantifying the health and economic value of achieving specific kidney function outcomes, helping guide clinical development priorities and pricing expectations for Lowe syndrome gene therapies.
